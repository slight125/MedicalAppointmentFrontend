    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 transition-colors duration-300">
      ...
      <section className="py-16 md:py-20 lg:py-24 xl:py-32 2xl:py-40 bg-gray-50 dark:bg-gray-800">
        <div className="max-w-screen-2xl 2xl:max-w-none mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 2xl:grid-cols-8 gap-4 lg:gap-6 xl:gap-8 2xl:gap-10">
            {specialties.map((specialty, index) => (
              <div
                key={index}
                className="bg-white dark:bg-gray-900 p-6 lg:p-8 xl:p-10 2xl:p-12 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 text-center border border-gray-100 dark:border-gray-700"
              >
                <div className="bg-blue-100 dark:bg-blue-900 w-12 h-12 lg:w-16 lg:h-16 xl:w-20 xl:h-20 2xl:w-24 2xl:h-24 rounded-lg flex items-center justify-center mx-auto mb-4 lg:mb-6 xl:mb-8">
                  <Stethoscope className="w-6 h-6 lg:w-8 lg:h-8 xl:w-10 xl:h-10 2xl:w-12 2xl:h-12 text-blue-600 dark:text-blue-400" />
                </div>
                <h3 className="text-sm lg:text-base xl:text-lg 2xl:text-xl font-semibold text-gray-900 dark:text-white">
                  {specialty}
                </h3>
              </div>
            ))}
      ...
      <section className="py-16 md:py-20 lg:py-24 xl:py-32 2xl:py-40">
        <div className="max-w-screen-2xl 2xl:max-w-none mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-10 xl:gap-12 2xl:gap-16">
            {benefits.map((benefit, index) => (
              <div
                key={index}
                className="text-center"
              >
                <div className="bg-blue-100 dark:bg-blue-900 w-16 h-16 lg:w-20 lg:h-20 xl:w-24 xl:h-24 2xl:w-32 2xl:h-32 rounded-full flex items-center justify-center mx-auto mb-6 lg:mb-8 xl:mb-10 2xl:mb-12">
                  <benefit.icon className="w-8 h-8 lg:w-10 lg:h-10 xl:w-12 xl:h-12 2xl:w-16 2xl:h-16 text-blue-600 dark:text-blue-400" />
                </div>
      ...
      {/* CTA Section */}
      <section className="py-16 md:py-20 lg:py-24 xl:py-32 2xl:py-40 bg-blue-600 dark:bg-blue-700">
        <div className="max-w-screen-2xl 2xl:max-w-none mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 text-center">
          <h2 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl font-bold text-white mb-4 lg:mb-6 xl:mb-8">
            Ready to Experience Better Healthcare?
          </h2>
          <p className="text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl text-blue-100 mb-8 lg:mb-12 xl:mb-16 max-w-5xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 lg:gap-6 xl:gap-8 justify-center">
            <Link
              to="/register"
              className="bg-white text-blue-600 px-8 py-3 lg:px-10 lg:py-4 xl:px-12 xl:py-5 2xl:px-16 2xl:py-6 text-base lg:text-lg xl:text-xl 2xl:text-2xl rounded-lg font-semibold hover:bg-gray-100 transition-colors duration-200 flex items-center justify-center gap-2 lg:gap-3 xl:gap-4"
            >
              Get Started Today
              <ArrowRight className="w-5 h-5 lg:w-6 lg:h-6 xl:w-7 xl:h-7 2xl:w-8 2xl:h-8" />
            </Link>
            <Link
              to="/contact"
              className="border-2 border-white text-white px-8 py-3 lg:px-10 lg:py-4 xl:px-12 xl:py-5 2xl:px-16 2xl:py-6 text-base lg:text-lg xl:text-xl 2xl:text-2xl rounded-lg font-semibold hover:bg-white hover:text-blue-600 transition-colors duration-200"
            >
              Learn More
            </Link>
          </div>
